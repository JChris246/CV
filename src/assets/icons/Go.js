...
const Go = ({ width, height }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 254.5 225" width={width} height={height}>
            <g>
                <g>
                    <g>
                        <g>
                            <path style={{ fill: "#2DBCAF" }} d="M40.2,101.1c-0.4,0-0.5-0.2-0.3-0.5l2.1-2.7c0.2-0.3,0.7-0.5,1.1-0.5l35.7,0c0.4,0,0.5,0.3,0.3,0.6
                ...
                <g>
                    <g>
                        <g>
                            <path style={{ fill: "#2DBCAF" }} d="M25.1,110.3c-0.4,0-0.5-0.2-0.3-0.5l2.1-2.7c0.2-0.3,0.7-0.5,1.1-0.5l45.6,0c0.4,0,0.6,0.3,0.5,0.6
                ...
                <g>
                    <g>
                        <g>
                            <path style={{ fill: "#2DBCAF" }} d="M49.3,119.5c-0.4,0-0.5-0.3-0.3-0.6l1.4-2.5c0.2-0.3,0.6-0.6,1-0.6l20,0c0.4,0,0.6,0.3,0.6,0.7l-0.2,2.4
                ...
                <g>
                    <g id="CXHf1q_1_">
                        <g>
                            <g>
                                <path style={{ fill: "#2DBCAF" }} d="M153.1,99.3c-6.3,1.6-10.6,2.8-16.8,4.4c-1.5,0.4-1.6,0.5-2.9-1c-1.5-1.7-2.6-2.8-4.7-3.8
                            ...
                            <g>
                                <path style={{ fill: "#2DBCAF" }} d="M186.2,154.6c-9.1-0.2-17.4-2.8-24.4-8.8c-5.9-5.1-9.6-11.6-10.8-19.3c-1.8-11.3,1.3-21.3,8.1-30.2
